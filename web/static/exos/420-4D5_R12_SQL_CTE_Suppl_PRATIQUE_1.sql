...
--  CONSEILS 
	...
	-- Faites une autre CTE qui donnera le nombre maximum de commande pour chacune des villes obtenues dans la deuxième CTE
	-- Faites la requête finale qui donnera le nom des clients dont le nombre de commande est dans les maximum obtenus dans la dernière CTE
...
-- Q2 Donner la liste des produits qui sont dans la catégorie (les catégories) ayant plus de produits que le nombre moyen de produits pour toutes les catégories réunies
--    Affichez les résultats en ordre de nom de catégorie puis en ordre de nom de produit
...
--    CONSEILS
	   ...
	   -- CTE pour obtenir les produits dans les catégories de la dernière CTE
